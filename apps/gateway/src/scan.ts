...
const rawScan = tripwire.scan as (text: string, direction: string, source?: string) => Finding[];

export type Direction = "Inbound" | "Outbound";
export type Source = "User" | "System" | "Tool" | "Document" | "McpDescription" | "ModelOutput";
